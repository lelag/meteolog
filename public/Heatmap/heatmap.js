...
(function(w){
    ...
    heatmap.prototype = {
        ...
        init: function(){
                ...
                canvas.width = acanvas.width = element.style.width.replace(/px/,"")*2 || me.getWidth(element)*2;
                me.set("width", canvas.width);
                canvas.height = acanvas.height = element.style.height.replace(/px/,"")*2 || me.getHeight(element)*2;
